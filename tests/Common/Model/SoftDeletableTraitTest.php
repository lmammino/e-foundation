...
class SoftDeletableTraitTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \LMammino\EFoundation\Common\Model\SoftDeletableTrait $softDeletable
     */
    ...
    {
        $this->softDeletable = $this->getMockForTrait('\LMammino\EFoundation\Common\Model\SoftDeletableTrait');
    }
