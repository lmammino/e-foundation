...
use LMammino\EFoundation\Model\Address\Address;
...
{
    /**
     * @var \LMammino\EFoundation\Model\Address\Address $address
     */
    private $address;
    ...
    {
        $this->assertInstanceOf('\LMammino\EFoundation\Model\Address\AddressInterface', $this->address);
    }
