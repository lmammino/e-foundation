...
use LMammino\EFoundation\Model\Attribute\AttributeValue;
...
class AttributeValueTest extends \PHPUnit_Framework_TestCase {
    ...
    {
        $this->assertInstanceOf('\LMammino\EFoundation\Model\Attribute\AttributeValueInterface', $this->attributeValue);
    }
    ...
    {
        $subject = $this->getMock('\LMammino\EFoundation\Model\Attribute\AttributeSubjectInterface');
