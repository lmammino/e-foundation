...
{
    /**
     * @var \LMammino\EFoundation\Model\Variation\VariableInterface $variable
     */
    private $variable;
    ...
    {
        $variant1 = $this->getMock('\LMammino\EFoundation\Model\Variation\VariantInterface');
        $variant2 = $this->getMock('\LMammino\EFoundation\Model\Variation\VariantInterface');
    ...
    {
        $variabilityOption = $this->getMock('\LMammino\EFoundation\Model\Variation\OptionInterface');
